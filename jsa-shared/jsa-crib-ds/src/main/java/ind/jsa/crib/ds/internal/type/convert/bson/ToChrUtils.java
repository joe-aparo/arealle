...
public class ToChrUtils {
	public Character bsonStr2Chr(BsonString val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.std.ToChrUtils.str2Chr(((BsonString) val).toString()) : null;
	}

	public Character bsonInt2Chr(BsonInt32 val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.std.ToChrUtils.lng2Chr(((BsonInt32) val).longValue()) : null;
	}
	
	public Character bsonLng2Chr(BsonInt64 val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.std.ToChrUtils.lng2Chr(((BsonInt64) val).longValue()) : null;
	}
	
	public Character bsonDbl2Chr(BsonDouble val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.std.ToChrUtils.dbl2Chr(((BsonDouble) val).doubleValue()) : null;
	}
