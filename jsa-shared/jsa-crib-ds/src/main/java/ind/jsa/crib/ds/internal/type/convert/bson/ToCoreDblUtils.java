...
public class ToCoreDblUtils {
	...
	public static Double bsonStr2Dbl(BsonString val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.core.ToDblUtils.str2Dbl(((BsonString) val).toString()) : null;
	}
	
	public static Double bsonInt2Dbl(BsonInt32 val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.core.ToDblUtils.lng2Dbl(((BsonInt32) val).longValue()) : null;		
	}
	
	public static Double bsonLng2Dbl(BsonInt64 val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.core.ToDblUtils.lng2Dbl(((BsonInt64) val).longValue()) : null;
	}
	...
	public static Double bsonBool2Dbl(BsonBoolean val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.core.ToDblUtils.bool2Dbl(((BsonBoolean) val).getValue()) : null;
	}
}
