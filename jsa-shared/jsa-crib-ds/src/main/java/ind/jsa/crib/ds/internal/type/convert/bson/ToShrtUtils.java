...
public class ToShrtUtils {
	...
	public static Short bsonStr2Shrt(BsonString val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.std.ToShrtUtils.str2Shrt(((BsonString) val).toString()) : null;
	}
	
	public static Short bsonInt2Shrt(BsonInt32 val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.std.ToShrtUtils.lng2Shrt(((BsonInt32) val).longValue()) : null;
	}
	
	public static Short bsonLng2Shrt(BsonInt64 val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.std.ToShrtUtils.lng2Shrt(((BsonInt64) val).longValue()) : null;
	}
	
	public static Short bsonDbl2Shrt(BsonDouble val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.std.ToShrtUtils.dbl2Shrt(((BsonDouble) val).doubleValue()) : null;
	}
