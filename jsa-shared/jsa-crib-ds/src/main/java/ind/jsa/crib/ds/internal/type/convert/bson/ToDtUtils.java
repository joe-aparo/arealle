...
public class ToDtUtils {
	...
	public static Date bsonStr2Dt(BsonString val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.std.ToDtUtils.str2Dt(((BsonString) val).toString()) : null;
	}
	
	public static Date bsonInt2Dt(BsonInt32 val) {
		return val != null ? 
			ind.jsa.crib.ds.internal.type.convert.std.ToDtUtils.lng2Dt(((BsonInt32) val).longValue()) : null;
	}
